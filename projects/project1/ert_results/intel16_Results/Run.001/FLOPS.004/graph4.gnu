...
set nox2tics
set noy2tics
set title "Graph 4 (inter16_Results/Run.001/FLOPS.004)"
...
set output "inter16_Results/Run.001/FLOPS.004/graph4.ps"
plot "inter16_Results/Run.001/FLOPS.004/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
