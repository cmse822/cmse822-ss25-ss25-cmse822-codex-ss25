...
set nox2tics
set noy2tics
set title "Graph 1 (inter16_Results/Run.001/FLOPS.016)"
...
set output "inter16_Results/Run.001/FLOPS.016/graph1.ps"
plot "inter16_Results/Run.001/FLOPS.016/pre" using 2:4
#EOF
