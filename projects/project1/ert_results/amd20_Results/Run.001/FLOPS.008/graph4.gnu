...
set nox2tics
set noy2tics
set title "Graph 4 (amd20_Results/Run.001/FLOPS.008)"
...
set output "amd20_Results/Run.001/FLOPS.008/graph4.ps"
plot "amd20_Results/Run.001/FLOPS.008/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
