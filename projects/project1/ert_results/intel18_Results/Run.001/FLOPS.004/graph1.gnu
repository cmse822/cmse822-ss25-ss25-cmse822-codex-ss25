...
set nox2tics
set noy2tics
set title "Graph 1 (intel18_Results/Run.001/FLOPS.004)"
...
set output "intel18_Results/Run.001/FLOPS.004/graph1.ps"
plot "intel18_Results/Run.001/FLOPS.004/pre" using 2:4
#EOF
