...
set nox2tics
set noy2tics
set title "Graph 4 (intel18_Results/Run.001/FLOPS.001)"
...
set output "intel18_Results/Run.001/FLOPS.001/graph4.ps"
plot "intel18_Results/Run.001/FLOPS.001/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
