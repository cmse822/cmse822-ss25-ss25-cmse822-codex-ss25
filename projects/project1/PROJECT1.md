...
* There is some strange behavior in the gravity solver for resolution 16, likely because the problem is so small that it can fit entirely within cache, leading to an increase in the measured bandwidth.
